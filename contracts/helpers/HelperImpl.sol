...
contract HelperImpl is Ownable {
    ...
    function balanceOf(IERC20[] memory tokens, address wallet)
        public view
    ...
    function totalSupply(IERC20[] memory tokens)
        public view
    ...
    function tokenPrice(IToken[] memory tokens)
        public view
    ...
    function supplyInterestRate(IToken[] memory tokens)
        public view
    ...
    function borrowInterestRate(IToken[] memory tokens)
        public view
        returns (uint256[] memory rates)
    {
        rates = new uint256[](tokens.length);
    ...
    function assetBalanceOf(IToken[] memory tokens, address wallet)
        public view
        returns (uint256[] memory balances)
    {
        balances = new uint256[](tokens.length);
    ...
    function profitOf(IToken[] memory tokens, address wallet)
        public view
    ...
    function marketLiquidity(IToken[] memory tokens)
        public view
    ...
    function reserveDetails(IToken[] memory tokens)
        public
        view
