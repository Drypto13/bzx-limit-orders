...
def main():
    accounts.load('main3')
    factoryContract = "0x4208A8f77Deb13Df41dDBd9408d7821cc8Cd3F44" #factory contract address
    factory = Contract.from_abi("FactoryContract",factoryContract,FactoryContract.abi)
    init_wallet(factory)
...
def submitTrade(smartWallet):
    ...
    price = str(1050*10**15) #execution price of order
    leverage = "2000000000000000000" #leverage for position
    lTokenAmount = "0" #loan token amount
    cTokenAmount = str(10**15) #collateral token amount
    ...
    tradeOrderStruct = [trader,loanID,iToken,loanToken,price,leverage,lTokenAmount,cTokenAmount,isActive,base,orderType,isCollateral,nonce,arbData]
